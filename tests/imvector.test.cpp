...
TEST(imvector, DefaultConstructor)
{
    imvector<int> v;
    EXPECT_TRUE(v.empty());
    EXPECT_EQ(v.size(), 0);
...
TEST(imvector, InitializerListConstructor)
{
...
TEST(imvector, EmptyInitializerList)
{
    imvector<int> v = {};
    EXPECT_TRUE(v.empty());
    EXPECT_EQ(v.size(), 0);
...
TEST(imvector, IteratorConstructor)
{
...
TEST(imvector, StdVectorConstructor)
{
...
TEST(imvector, FillConstructorZeroCount)
{
    imvector<int> v(0, 42);
    EXPECT_TRUE(v.empty());
    EXPECT_EQ(v.size(), 0);
...
TEST(imvector, AtMethodOutOfRange)
{
    imvector<int> v = {10, 20, 30};
...
TEST(imvector, FrontMethodEmpty)
{
    imvector<int> v;
...
TEST(imvector, ExplicitSpanConversion)
{
...
TEST(imvector, ReverseIterators)
{
...
TEST(imvector, CopySharesStorage)
{
    imvector<int> v1 = {1, 2, 3};
...
TEST(imvector, MoveTransfersOwnership)
{
    imvector<int> v1 = {1, 2, 3};
    const int* p1 = v1.data();
...
TEST(imvector, EmptyRangeConstructor)
{
...
TEST(imvector, MultipleCopiesShareData)
{
...
TEST(imvector, EmptyVectorOperations)
{
    imvector<int> v1;
    imvector<int> v2;
...
TEST(imvector, EmptyVectorIterator)
{
    imvector<int> v;
...
TEST(imvector, InputIteratorConstructor)
{
...
TEST(imvector, EmptyInputIteratorConstructor)
{
...
TEST(imvector_builder, BuildTransfersData)
{
...
TEST(imvector_builder, BuilderReuseAfterBuild)
{
    imvector<int>::builder b;
...
TEST(imvector_builder, BuildWithEmplaceBack)
{
...
TEST(imvector_builder, BuildWithAppend)
{
    imvector<int>::builder b;
...
TEST(imvector_builder, BuildWithReserveAndGrowth)
{
    imvector<int>::builder b;
    b.reserve(10);
...
TEST(imvector_builder, BuildEmptyBuilder)
{
    imvector<int>::builder b;
...
TEST(imvector_builder, MultipleBuildCycles)
{
    imvector<int>::builder b;
...
TEST(imvector_builder, BuildWithNonTrivialTypes)
{
    imvector<std::string>::builder b;
...
TEST(imvector_builder, BuildAfterMultipleReallocations)
{
    imvector<int>::builder b;
...
TEST(imvector_builder, BuilderMoveOwnershipTransfer)
{
...
TEST(imvector_builder, BuildedImvectorRefCounting)
{
    imvector<int>::builder b;
    b.push_back(7);
    b.push_back(14);
...
TEST(imvector_builder, ResizeGrow)
{
    imvector<int>::builder b;
    b.push_back(10);
    b.push_back(20);
...
TEST(imvector_builder, ResizeShrink)
{
    imvector<int>::builder b;
    b.push_back(100);
    b.push_back(200);
...
// Test resize to zero
TEST(imvector_builder, ResizeToZero)
{
    imvector<int>::builder b;
    b.push_back(1);
    b.push_back(2);
...
TEST(imvector_builder, ResizeToSameSize)
{
    imvector<int>::builder b;
    b.push_back(5);
    b.push_back(10);
...
TEST(imvector_builder, ResizeGrowThenShrink)
{
    imvector<int>::builder b;
    b.push_back(1);
    b.push_back(2);
...
TEST(imvector_builder, ResizeWithNonTrivialTypes)
{
    imvector<std::string>::builder b;
    b.push_back("hello");
    b.push_back("world");
...
TEST(imvector_builder, ResizeShrinkNonTrivialTypes)
{
    imvector<std::string>::builder b;
    b.push_back("first");
    b.push_back("second");
...
TEST(imvector_builder, ResizeThenBuild)
{
    imvector<int>::builder b;
    b.push_back(10);
    b.push_back(20);
...
TEST(imvector_builder, ResizeEmptyBuilder)
{
    imvector<int>::builder b;
...
TEST(imvector_builder, ResizeWithReserveCapacity)
{
    imvector<int>::builder b;
    b.reserve(10);
...
TEST(imvector_builder, BuilderIndexAccessAfterResize)
{
    imvector<int>::builder b;
    b.resize(3);
